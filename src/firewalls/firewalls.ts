...
export class Firewalls extends BaseAPI {
	...
	async getAll(
		...
		| { success: true; response: FirewallsResponse }
	...
	> {
		...
		return this.request<FirewallsResponse>(
			`/firewalls${queryString ? `?${queryString}` : ""}`,
		);
	}
	...
	async create(
		...
		| { success: true; response: FirewallCreateResponse }
		| { success: false; response: APIError }
	> {
	...
	async get(
		...
		| { success: true; response: { firewall: Firewall } }
		| { success: false; response: APIError }
	> {

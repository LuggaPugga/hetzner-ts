...
export class LoadBalancers extends BaseAPI {
	...
	async getAll(
		...
		| { success: true; response: LoadBalancersResponse }
	...
	async create(
		...
		| { success: true; response: CreateLoadBalancerResponse }
		| { success: false; response: APIError }
	> {
	...
	async get(
		...
		| { success: true; response: LoadBalancerResponse }
		| { success: false; response: APIError }
	> {
	...
	async delete(id: number): Promise<
		...
		| { success: false; response: APIError }
	> {
		return this.request<null | LoadBalancerActionResponse>(
			`/load_balancers/${id}`,
			{
				method: "DELETE",
			},
